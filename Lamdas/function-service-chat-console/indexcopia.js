...
exports.handler = async(event) => {
    try {
        ...
        nameCustomer = event.message.chat.first_name;
        ...
        jsonDataTG.fechaMsg = Today.toISOString().substring(0, 10);
        ...
        if (getDara.hasOwnProperty('data')) {
            ...
            //   await invocaiones(chatId, msgId, tipo, payload, Today)
...
async function invocaiones(userId, messageId, tipo, payload, Today) {
